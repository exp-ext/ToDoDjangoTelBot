...
class TaskParse:
    ...
    -message: str,
    -time_zone: str,
    -server_date: datetime with pytz | None,
    -user_date: datetime with pytz | None,
    ...
    изменяя значения атрибутов класса.
    -it_birthday: bool - возвращает результат совпадения с birthday_list.
    -get_parameters: str - разделяет строку, возвращает параметр повтора и
    убирает параметр из атрибута message.
    """
